...
--
-- Host: localhost    Database: fxsample
-- ------------------------------------------------------
...
) ENGINE=MyISAM AUTO_INCREMENT=39 DEFAULT CHARSET=utf8 COMMENT='模型属性字段表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM AUTO_INCREMENT=153 DEFAULT CHARSET=utf8 COMMENT='权限规则表：admin模块对应后台菜单';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ct_document` (
  ...
  `yqpl` varchar(20) NOT NULL,
  `yqgl` varchar(50) NOT NULL,
  `yqweight` varchar(50) NOT NULL,
  `jyprice` varchar(50) NOT NULL,
...
CREATE TABLE `ct_picture` (
  ...
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=128 DEFAULT CHARSET=utf8 COMMENT='上传图片信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ct_tags` (
  ...
  `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '状态',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='标签表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ct_ucenter_member` (
  ...
  KEY `status` (`status`)
) ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='UCenter用户表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-05-05 14:30:48
